                                ...
                                <div class="hstack gap-2 justify-content-end">
                                    <div class="dropdown">
                                        ...
                                        <ul class="dropdown-menu">
                                            <li>
                                                <a class="dropdown-item" href="javascript:void(0)" onclick="ROLE.copyRole(${value['id']})">
                                                    <i class="feather feather-copy me-3"></i>
                                                    <span>Copy</span>
                                                </a>
                                            </li>
                                            <li>
                                                <a class="dropdown-item" href="javascript:void(0)" onclick="ROLE.selectRole(${value['id']});">
                                                    <i class="feather feather-edit-3 me-3"></i>
                                                    <span>Edit</span>
                                                </a>
                                            </li>
                                            <li>
                                                <a class="dropdown-item" href="javascript:void(0)" onclick="ROLE.removeRole(${value['id']})">

...
Putting 1 is equivalent to putting 0 and calling Ln() just after. Default value: 0.
	 ...
	 * @public
	 */
	public function writeHTMLCell($w, $h, $x, $y, $html='', $border=0, $ln=0, $fill=false, $reseth=true, $align='', $autopadding=true, $maxh = 0, $valign = 'T') {
		return $this->MultiCell($w, $h, $html, $border, $align, $fill, $ln, $x, $y, $reseth, 0, true, $autopadding, $maxh, $valign, false);
	}

...
$routes->post('portal/employee/e-cancel-salary-advance-application', 'Portal\LoanController::e_cancelSalaryAdvanceApplication');
...
$routes->post('portal/representative/r-resend-employee-email', 'Portal\EmployeeController::r_resendEmployeeEmail');
...
$routes->get('portal/representative/r-print-employee-list/(:any)/(:any)/(:any)', 'Portal\EmployeeController::r_printEmployeeList/$1/$2/$3');

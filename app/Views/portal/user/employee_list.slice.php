                                ...
                                <div class="card">
                                    <div class="card-body">
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-8 col-xl-3 d-grid">
                                                <button type="button" data-bs-toggle="modal" data-bs-target="#standard-modal" class="btn gwc-button waves-effect waves-light"><i class="fe-plus"></i> BATCH UPLOAD</button>
                                            </div>
                                        </div>
                                        ...
                                        <div class="justify-content-end row mt-3">
                                            <div class="col-8 col-xl-3 d-grid">
                                                <button type="submit" class="btn gwc-button waves-effect waves-light">Print Updated List</button>
                                            </div>
                                            <div class="col-8 col-xl-3 d-grid">
                                                <button type="submit" class="btn gwc-button waves-effect waves-light">Attach Documents</button>
                                            </div>
                                        </div>

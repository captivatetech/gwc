    ...
    <div class="content-page">
        <div class="content">
            ...
            <div class="container-fluid">
                ...
                <div class="row" id="div_businessExpansionSubscriptionsList">
                    <div class="col-12">
                        <div class="card">
                            <div class="card-body">
                                ...
                                <table id="tbl_businessExpansionSubscriptions" class="table table-sm table-bordered table-hover nowrap mb-3" style="width: 100%;">
                                    <thead>
                                        <tr>
                                            <th>On Board Date</th>
                                            <th>Company Name</th>
...
<script type="text/javascript">
  $(document).ready(function(){
    ...
    $('#tbl_businessExpansionSubscriptions').DataTable();

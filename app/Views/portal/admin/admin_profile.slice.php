                        ...
                        <div class="card">
                            <div class="card-body">
                                ...
                                <form id="form_changePassword">
                                    <input type="password" class="form-control" id="txt_oldPassword" name="txt_oldPassword" placeholder="Old Password" required>
                                    <input type="password" class="form-control" id="txt_newPassword" name="txt_newPassword" placeholder="New Password" required>
                                    ...
                                    <button type="submit" class="btn btn-primary" id="btn_submitChangePassword">Change Password</button>
                                </form>
                            </div>
                        </div>
                    </div>

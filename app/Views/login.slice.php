                            ...
                            <div class="card-body p-4">
                                ...
                                <form action="#">
                                    ...
                                    <div class="mb-3 d-grid text-center">
                                        <button class="btn gwc-button" type="submit"> LOG IN </button>
                                    </div>
                                </form>
                                <p class="text-center"> <a href="pages-recoverpw.html" class="text-muted ms-1"><i class="fa fa-lock me-1"></i>Forgot your password?</a></p>
                            </div> <!-- end card-body -->
                        </div>
                        <!-- end card -->

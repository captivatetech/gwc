...
<a href="<?php echo base_url(); ?>change-password/r/{{ $emailAddress }}/{{ $authCode }}">
...
<div style="text-align: center;"><span style="font-family: Poppins, Helvetica, Arial, sans-serif; font-weight: 500; font-style: normal; color: rgb(169, 127, 54);"><code><?php echo base_url(); ?>change-password/r/{{ $emailAddress }}/{{ $authCode }}</code></span></div>

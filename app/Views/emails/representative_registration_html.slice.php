...
<html xmlns="http://www.w3.org/1999/xhtml" xmlns:o="urn:schemas-microsoft-com:office:office" xmlns:v="urn:schemas-microsoft-com:vml">
    <head>
        ...
        <![endif]-->
        <!--[if !mso]><!--><!--<![endif]-->
        <style>a:not([name]) {color:#000;font-weight:normal;text-decoration:underline;font-style:normal}
        a:link {color:#000;font-weight:normal;text-decoration:underline;font-style:normal}
        ...
        a:hover {color:#000;font-weight:normal;text-decoration:underline;font-style:normal}</style><style>@import url(https://static-forms.klaviyo.com/fonts/api/v1/WVMenL/custom_fonts.css);
        #outlook a {
        padding: 0
        }
        body {
    ...
    <body style="word-spacing:normal;background-color:#f7f7f7;">
        ...
        <tbody>
        <tr>
        <td style="direction:ltr;font-size:0px;padding:20px 0;padding-bottom:70px;padding-left:18px;padding-right:18px;padding-top:70px;text-align:center;">
        <!--[if mso | IE]><table role="presentation" border="0" cellpadding="0" cellspacing="0"><![endif]-->
        ...
        <div style="text-align: center;"><span style="font-family: Poppins, Helvetica, Arial, sans-serif; font-weight: 400; font-style: normal;"><strong>This is the start of our partnership. </strong></span><br/><span style="font-family: Poppins, Helvetica, Arial, sans-serif; font-weight: 400; font-style: normal;"><strong>Verify your email by clicking this <a href="<?php echo base_url(); ?>representative-email-verification/{{ $emailAddress }}/{{ $authCode }}" style="text-decoration: none;"><span style="color: rgb(169, 127, 54);">link</span></a></strong></span></div></div>
        </td>
        </tr>
        </tbody>
        </table>
        ...
        <a href="https://www.klaviyo.com/?utm_medium=freebie&amp;utm_source=brand&amp;utm_term=WVMenL" style="color:#000; font-style:normal; font-weight:normal; text-decoration:underline" target="_blank">
